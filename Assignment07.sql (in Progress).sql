--*************************************************************************--
-- Title: Assignment07
-- Author: SepehrRouhani
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2017-01-01,SepehrRouhani,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_SepehrRouhani')
	 Begin 
	  Alter Database [Assignment07DB_SepehrRouhani] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_SepehrRouhani;
	 End
	Create Database Assignment07DB_SepehrRouhani;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_SepehrRouhani;
...
,[PreviousMonthCount] = CASE 
  When InventoryDate like 'January%' Then 0 Else IsNull(Lag([Count]) Over (Order By ProductName, Year(InventoryDate)), 0) 
END
